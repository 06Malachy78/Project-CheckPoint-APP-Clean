  ...
  return (
    <Link href={`/review/${review.id}`} className="block hover:opacity-80 transition">
      <div className="bg-zinc-900/40 border border-zinc-800/50 p-5 rounded-2xl backdrop-blur-sm min-h-[190px] overflow-hidden">
        ...
        <div className="text-zinc-400 leading-relaxed break-words whitespace-pre-wrap text-sm overflow-hidden" style={{ display: '-webkit-box', WebkitLineClamp: 4, WebkitBoxOrient: 'vertical' }}>
          {review.content}
        </div>

        <div className="mt-3 text-[10px] uppercase tracking-widest text-zinc-600 font-bold">
